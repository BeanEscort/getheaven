                ...
                <form action="{{route('send-email')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">E-mail com PHPMailer</h4>
                        </div>

                        <div class="card-body">
                            <div class="form-group">
                                <label for="nome">Nome</label>
                                <input type="nome" name="nome" id="nome" class="form-control" placeholder="Seu nome">
                            </div>

                            <div class="form-group">
                                <label for="email">Seu E-mail </label>
                                <input type="email" name="email" id="email" class="form-control" placeholder="Entre com seu e-mail">
                            </div>
